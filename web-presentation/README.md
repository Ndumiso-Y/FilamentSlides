...
## Major Interactive TRP Concepts
...
- `src/assets/trp/image42.png` - Sasol Mining TOC reference letter
- `src/assets/trp/image43.png` - Sasol Mining endorsement
- `src/assets/trp/source-diagrams/poogi-performance-source.png` - POOGI source chart
- `src/assets/trp/source-diagrams/chasm-source.png` - Chasm/adoption source visual
...
|---:|---|---|---|---|
| 1 | Productivity Transformation, One Person at a Time. | FILAMENT.pdf P1 / TRP S1 | Recreated hero | Confirmed exact source |
| 2 | Executive storyline | TRP S2 | Redesigned contents | Confirmed exact source |
| 3 | Why productivity transformation matters | TRP S6-S8 | Recreated | Confirmed source, redesigned |
| 4 | Employer problem-solving dilemma | TRP S4-S5 | Interactive orbit | Confirmed exact source |
| 5 | Highly interdependent mining system | TRP S5/S8 | Animated lane model | Confirmed source, redesigned |
| 6 | VUCA, governance and MHSA pressure | TRP S5 | Recreated comparison | Confirmed exact source |
| 7 | Resource management and The Goal | TRP S6-S7 | Recreated | Confirmed exact source |
| 8 | Mining as ROI | TRP S7-S8 | Animated process | Confirmed source, redesigned |
| 9 | Linear mining process logic | TRP S8 | Flowline diagram | Confirmed source, redesigned |
| 10 | Day in the life of an employer | TRP S10 | Demand matrix | Confirmed exact source |
| 11 | Transactional vs transformational improvement | TRP S9 | Comparison | Confirmed exact source |
...
| 18 | TOC foundation | TRP S11/S30 | Interactive orbit | Confirmed source, redesigned |
| 19 | Five focusing steps | TRP S11/S30 | Animated loop | Confirmed source, redesigned |
| 20 | Balanced flowline | TRP S12-S13 | Source-faithful animated flowline | Confirmed exact source, recreated |
| 21 | Unbalanced flowline | TRP S14 | Source-faithful animated flowline | Confirmed exact source, recreated |
| 22 | Blockage, starvation and buffer logic | TRP S15 | Animated system diagram | Confirmed source, redesigned |
| 23 | Continuous improvement methodology | TRP S16 | Method sequence diagram | Confirmed exact source |
| 24 | POOGI implementation profile | TRP S17 | Source chart with magnifier | Source visual used |
| 25 | Unique value proposition and ROI | TRP S18-S19 | Recreated | Confirmed exact source |
| 26 | Lean transformation architecture | TRP S23-S24 | Layered architecture | Confirmed source, redesigned |
| 27 | Lean transformation timeframe | TRP S26-S27 | Five-year transformation timeline | Confirmed exact source, redesigned |
| 28 | The sustainment problem | TRP S22/S28 | Comparison | Confirmed exact source |
| 29 | Crossing the Chasm | TRP S29 | Source chart with magnifier | Source visual used |
| 30 | Graduate capability and sustainment | TRP S44 | Animated pipeline | Confirmed exact source, redesigned |
| 31 | Win-win-win strategy | TRP S45 | Premium stakeholder model | Confirmed exact source |
| 32 | Proof: credentials and results | TRP S33-S38 | Performance proof panels | Confirmed exact source |
| 33 | Endorsements as source evidence | TRP S39-S43 | Evidence wall | Source visual used |
...
| 41 | Proposed engagement and opportunity | TRP S46 | Recreated | Confirmed exact source |
| 42 | Quo Vadis: way forward | TRP S47 | Animated timeline | Confirmed source, redesigned |
